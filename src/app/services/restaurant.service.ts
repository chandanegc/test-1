...
import { Restaurant, MenuItem, CuisineType } from '.././shared/models/restaurant.model';
...
export class RestaurantService {
  ...
  getFeaturedRestaurants(): Observable<Restaurant[]> {
    return this.apiService.get<Restaurant[]>('restaurants/featured');
  }
  ...
  getMenuItem(restaurantId: string, itemId: string): Observable<MenuItem> {
    return this.apiService.get<MenuItem>(`restaurants/${restaurantId}/menu/${itemId}`);
  }
